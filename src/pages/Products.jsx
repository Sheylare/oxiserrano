    ...
    <div className="products">
      ...
      {cardSeleccionada === "reguladores" && (
        <div className="reguladores-section">
          ...
          <Card className="card-content">
            <div>
              <Card.Img src={reguladorVaso} className="card-images img-fluid" />
            </div>
            <Card.Title>
          ...
          <Card className="card-content">
            <div>
              <Card.Img src={reguladorCGA} className="card-images img-fluid" />
            </div>
            <Card.Title>
      ...
      {cardSeleccionada === "concentradoresFiltros" && (
        <div className="concentradores-section">
          ...
          <Card className="card-content">
            <div>
              <Card.Img src={filtroInogen} className="card-images img-fluid" />
            </div>
            <Card.Title>Filtro entrada Inogen</Card.Title>
          </Card>
          <Card className="card-content">
            <div>
              <Card.Img src={filtroInogens} className="card-images img-fluid" />
            </div>
      ...
      {cardSeleccionada === "otros" && (
        <div className="otros-section">
          <Card className="card-content">
            <div>
              <Card.Img src={nebulPediatrico} className="card-images img-fluid" />
            </div>
            <Card.Title>
